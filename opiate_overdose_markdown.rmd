...
The model-building process focused on factors that are correlated with heroin overdose per the drug abuse academic literature and popular report. Factor selection was influenced by the higher heroin overdose rate among White men than men of other racial/ethnic groups, and this likely introduced bias into the model, as seen by the much greater mean absolute error for majority-Nonwhite neighborhoods (+/- 5 overdose events, on average) than for majority-White neighborhoods (+/- less than one overdose event, on average).
