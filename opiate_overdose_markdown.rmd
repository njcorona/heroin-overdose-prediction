...
First, a poisson regression is specified and trained on the pooled data from 2015-2018. A year fixed effect, and a quadratic polynomial term representing year-squared, are included as predictors in the model to account for time effects as well as the curvature of the time effect.

```{r training}
column_names <- colnames(final_net)
reg.vars <- c("abandoned_cars.nn", "Adult Entertainment", "Assault Crimes", "adult_entertainment.nn", "SNA_NAME", "zone_type")
